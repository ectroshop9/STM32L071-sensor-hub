...
- [Configure and build a project with CMake Presets](https://github.com/quanzhuo/vscode-cmake-tools/blob/HEAD/docs/cmake-presets.md)
- [Configure a project with kits and variants](https://github.com/quanzhuo/vscode-cmake-tools/blob/HEAD/docs/how-to.md#configure-a-project)
- [Build a project with kits and variants](https://github.com/quanzhuo/vscode-cmake-tools/blob/HEAD/docs/how-to.md#build-a-project)
- [Configure and build a project using tasks](https://github.com/quanzhuo/vscode-cmake-tools/blob/HEAD/docs/tasks.md)
- [Debug a project](https://github.com/quanzhuo/vscode-cmake-tools/blob/HEAD/docs/how-to.md#debug-a-project)
- [Configure CMake Tools settings](https://github.com/quanzhuo/vscode-cmake-tools/blob/HEAD/docs/cmake-settings.md)
- [How to](https://github.com/quanzhuo/vscode-cmake-tools/blob/HEAD/docs/how-to.md)
- [FAQ](https://github.com/quanzhuo/vscode-cmake-tools/blob/HEAD/docs/faq.md)
- [Read the online documentation](https://github.com/quanzhuo/vscode-cmake-tools/blob/HEAD/docs/README.md)
- [Contribute](https://github.com/quanzhuo/vscode-cmake-tools/blob/HEAD/CONTRIBUTING.md)
