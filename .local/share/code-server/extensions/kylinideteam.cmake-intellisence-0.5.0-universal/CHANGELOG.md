...
* Fix [#1](https://github.com/quanzhuo/cmake-intellisence/issues/1): ()不在同一行的时候，执行格式化，)会自动格式化到行首
...
* Fix [#2](https://github.com/quanzhuo/cmake-intellisence/issues/2): Unquoted arguments can contain quotes
